...
import { listBuckets, createBucket, deleteBucket, headBucket, doesBucketExist, getBucketInfo, putBucketStorageClass } from './methods/bucket/base';
import { getBucketAcl, putBucketAcl } from './methods/bucket/acl';
import { getBucketHttpsConfig, putBucketHttpsConfig } from './methods/bucket/httpsConfig';
...
import { createMultiRegionAccessPoint, getMultiRegionAccessPoint, listMultiRegionAccessPoints, getMultiRegionAccessPointRoutes, deleteMultiRegionAccessPoint, submitMultiRegionAccessPointRoutes, listBindAccessPointForMultiRegionAccelerator, bindAcceleratorWithMultiRegionAccessPoint, unbindAcceleratorWithMultiRegionAccessPoint } from './methods/mrap';
import { createAccessPoint, getAccessPoint, listAccessPoints, deleteAccessPoint, listBindAccessPointForAccelerator, bindAcceleratorWithAccessPoint, unbindAcceleratorWithAccessPoint } from './methods/accesspoint';
import { putAccelerator, getAccelerator, deleteAccelerator, listAccelerators, listAcceleratorAzs, putAcceleratorPrefetchJob, getAcceleratorPrefetchJob, deleteAcceleratorPrefetchJob, listAcceleratorPrefetchJobs, listAcceleratorPrefetchJobRecords, getAcceleratorCapacityQuota, listBindAcceleratorForAccessPoint } from './methods/accelerator';
import { putBucketPrivateM3U8, getBucketPrivateM3U8, putBucketBlindWatermark, getBucketBlindWatermark } from './methods/bucket/media';
import { getBucketTrash, putBucketTrash } from './methods/bucket/trash';
import { putBucketObjectLockConfiguration, getBucketObjectLockConfiguration } from './methods/bucket/lock';
import { putObjectRetention, getObjectRetention } from './methods/object/retention';
import { putBucketCdnNotification, getBucketCdnNotification, deleteBucketCdnNotification } from './methods/bucket/cdnNotification';
import { getBucketWorkflow, putBucketWorkflow, deleteBucketWorkflow, getBucketWorkflowExecution, listBucketWorkflowExecution } from './methods/bucket/workflow';
import { createFileCompress } from './methods/fileCompress';
import { createFileUncompress } from './methods/fileUncompress';
import { deleteBucketLogging, getBucketLogging, putBucketLogging } from './methods/bucket/logging';
import { putAccessPointPolicy, getAccessPointPolicy, deleteAccessPointPolicy, putMultiRegionAccessPointPolicy, getMultiRegionAccessPointPolicy, deleteMultiRegionAccessPointPolicy } from './methods/mrap/policy';
import { putBucketAudit, getBucketAudit, listBucketAuditJob, getBucketAuditJob, postBucketAuditJob, listBucketAuditBizType, postBucketIncrementAudit, listBucketIncrementAudits, getBucketIncrementAudit, deleteBucketIncrementAudit } from './methods/bucket/audit';
...
import { getBucketRequestPayment, putBucketRequestPayment } from './methods/bucket/requestPayment';
import { createDataset, deleteDataset, listDataset, getDataset } from './methods/datasetSearch/dataset';
import { createDatasetBinding, deleteDatasetBinding, listDatasetBindings, getDatasetBinding } from './methods/datasetSearch/binding';
import { datasetSimpleQuery, datasetSemanticQuery } from './methods/datasetSearch/query';
import { putBucketDataProcessTemplate, getBucketDataProcessTemplate, deleteBucketDataProcessTemplate, listBucketDataProcessTemplates } from './methods/bucket/template';
import { putAudioConvertTemplate, getAudioConvertTemplate, deleteAudioConvertTemplate, listAudioConvertTemplates, getVideoConvertTemplate, deleteVideoConvertTemplate, putVideoConvertTemplate, listVideoConvertTemplates } from './methods/bucket/templatesV2';
import { createVideoConvertJob, getVideoConvertJob, createAudioConvertJob, getAudioConvertJob } from './methods/bucket/mediaJob';
import { listTemplates } from './methods/datasetSearch/template';
import { createBucketDataRedundancyTransition, deleteBucketDataRedundancyTransition, getBucketDataRedundancyTransition, getBucketTransitionEstimatedRemainingTime, listBucketDataRedundancyTransition, listUserDataRedundancyTransition } from './methods/bucket/dataRedundancy';
...
export declare class InnerClient extends TOSBase {
    ...
    doesBucketExist: typeof doesBucketExist;
    ...
    putBucketHttpsConfig: typeof putBucketHttpsConfig;
    getBucketHttpsConfig: typeof getBucketHttpsConfig;
    ...
    getFetchTask: typeof getFetchTask;
    ...
    bindAcceleratorWithMultiRegionAccessPoint: typeof bindAcceleratorWithMultiRegionAccessPoint;
    unbindAcceleratorWithMultiRegionAccessPoint: typeof unbindAcceleratorWithMultiRegionAccessPoint;
    listBindAccessPointForMultiRegionAccelerator: typeof listBindAccessPointForMultiRegionAccelerator;
    ...
    putMultiRegionAccessPointPolicy: typeof putMultiRegionAccessPointPolicy;
    getMultiRegionAccessPointPolicy: typeof getMultiRegionAccessPointPolicy;
    deleteMultiRegionAccessPointPolicy: typeof deleteMultiRegionAccessPointPolicy;
    putAccessPointPolicy: typeof putAccessPointPolicy;
    getAccessPointPolicy: typeof getAccessPointPolicy;
    deleteAccessPointPolicy: typeof deleteAccessPointPolicy;
    createAccessPoint: typeof createAccessPoint;
    getAccessPoint: typeof getAccessPoint;
    listAccessPoints: typeof listAccessPoints;
    deleteAccessPoint: typeof deleteAccessPoint;
    bindAcceleratorWithAccessPoint: typeof bindAcceleratorWithAccessPoint;
    unbindAcceleratorWithAccessPoint: typeof unbindAcceleratorWithAccessPoint;
    listBindAccessPointForAccelerator: typeof listBindAccessPointForAccelerator;
    listAcceleratorAzs: typeof listAcceleratorAzs;
    putAccelerator: typeof putAccelerator;
    getAccelerator: typeof getAccelerator;
    listAccelerators: typeof listAccelerators;
    deleteAccelerator: typeof deleteAccelerator;
    listBindAcceleratorForAccessPoint: typeof listBindAcceleratorForAccessPoint;
    putAcceleratorPrefetchJob: typeof putAcceleratorPrefetchJob;
    getAcceleratorPrefetchJob: typeof getAcceleratorPrefetchJob;
    deleteAcceleratorPrefetchJob: typeof deleteAcceleratorPrefetchJob;
    listAcceleratorPrefetchJobs: typeof listAcceleratorPrefetchJobs;
    listAcceleratorPrefetchJobRecords: typeof listAcceleratorPrefetchJobRecords;
    getAcceleratorCapacityQuota: typeof getAcceleratorCapacityQuota;
    putBucketPrivateM3U8: typeof putBucketPrivateM3U8;
    getBucketPrivateM3U8: typeof getBucketPrivateM3U8;
    putBucketBlindWatermark: typeof putBucketBlindWatermark;
    getBucketBlindWatermark: typeof getBucketBlindWatermark;
    putBucketTrash: typeof putBucketTrash;
    getBucketTrash: typeof getBucketTrash;
    putBucketObjectLockConfiguration: typeof putBucketObjectLockConfiguration;
    getBucketObjectLockConfiguration: typeof getBucketObjectLockConfiguration;
    putObjectRetention: typeof putObjectRetention;
    getObjectRetention: typeof getObjectRetention;
    putBucketCdnNotification: typeof putBucketCdnNotification;
    getBucketCdnNotification: typeof getBucketCdnNotification;
    deleteBucketCdnNotification: typeof deleteBucketCdnNotification;
    putBucketWorkflow: typeof putBucketWorkflow;
    getBucketWorkflow: typeof getBucketWorkflow;
    deleteBucketWorkflow: typeof deleteBucketWorkflow;
    getBucketWorkflowExecution: typeof getBucketWorkflowExecution;
    listBucketWorkflowExecution: typeof listBucketWorkflowExecution;
    putConvertWorkflow: typeof putConvertWorkflow;
    getConvertWorkflow: typeof getConvertWorkflow;
    deleteConvertWorkflow: typeof deleteConvertWorkflow;
    putBucketAudit: typeof putBucketAudit;
    getBucketAudit: typeof getBucketAudit;
    listBucketAuditJob: typeof listBucketAuditJob;
    getBucketAuditJob: typeof getBucketAuditJob;
    postBucketAuditJob: typeof postBucketAuditJob;
    listBucketAuditBizType: typeof listBucketAuditBizType;
    postBucketIncrementAudit: typeof postBucketIncrementAudit;
    listBucketIncrementAudits: typeof listBucketIncrementAudits;
    getBucketIncrementAudit: typeof getBucketIncrementAudit;
    deleteBucketIncrementAudit: typeof deleteBucketIncrementAudit;
    createFileCompress: typeof createFileCompress;
    createFileUncompress: typeof createFileUncompress;
    createBucketAudioConvert: typeof createBucketAudioConvert;
    getAudioConvertJob: typeof getAudioConvertJob;
    createAudioConvertJob: typeof createAudioConvertJob;
    listBucketJob: typeof listBucketJob;
    getBucketJob: typeof getBucketJob;
    ...
    getObjectAITag: typeof getObjectAITag;
    ...
    listDataset: typeof listDataset;
    getDataset: typeof getDataset;
    createDatasetBinding: typeof createDatasetBinding;
    deleteDatasetBinding: typeof deleteDatasetBinding;
    listDatasetBindings: typeof listDatasetBindings;
    getDatasetBinding: typeof getDatasetBinding;
    datasetSimpleQuery: typeof datasetSimpleQuery;
    listTemplates: typeof listTemplates;
    datasetSemanticQuery: typeof datasetSemanticQuery;
    putBucketDataProcessTemplate: typeof putBucketDataProcessTemplate;
    putAudioConvertTemplate: typeof putAudioConvertTemplate;
    getBucketDataProcessTemplate: typeof getBucketDataProcessTemplate;
    deleteBucketDataProcessTemplate: typeof deleteBucketDataProcessTemplate;
    listBucketDataProcessTemplates: typeof listBucketDataProcessTemplates;
    getAudioConvertTemplate: typeof getAudioConvertTemplate;
    deleteAudioConvertTemplate: typeof deleteAudioConvertTemplate;
    listAudioConvertTemplates: typeof listAudioConvertTemplates;
    putVideoConvertTemplate: typeof putVideoConvertTemplate;
    getVideoConvertTemplate: typeof getVideoConvertTemplate;
    deleteVideoConvertTemplate: typeof deleteVideoConvertTemplate;
    listVideoConvertTemplates: typeof listVideoConvertTemplates;
    createVideoConvertJob: typeof createVideoConvertJob;
    getVideoConvertJob: typeof getVideoConvertJob;
    createBucketDataRedundancyTransition: typeof createBucketDataRedundancyTransition;
    getBucketDataRedundancyTransition: typeof getBucketDataRedundancyTransition;
    listBucketDataRedundancyTransition: typeof listBucketDataRedundancyTransition;
    deleteBucketDataRedundancyTransition: typeof deleteBucketDataRedundancyTransition;
    listUserDataRedundancyTransition: typeof listUserDataRedundancyTransition;
    getBucketTransitionEstimatedRemainingTime: typeof getBucketTransitionEstimatedRemainingTime;
    putAnyPrivateAccessPoint: typeof putAnyPrivateAccessPoint;
    listAnyPrivateAccessPoints: typeof listAnyPrivateAccessPoints;
    listAnyPrivateAccessPointSupportAz: typeof listAnyPrivateAccessPointSupportAz;
    listAnyPrivateAccessPointEndpoints: typeof listAnyPrivateAccessPointEndpoints;
}
