 ...
 * @private unstable
 */
export declare enum WorkflowExecutionStateType {
    Success = "Success",
    Running = "Running",
    Submitted = "Submitted",
    Failed = "Failed"
...
/** @private unstable */
export declare enum FileCompressFlatten {
 ...
 * @private unstable
 */
export declare enum FileUncompressPrefixReplaced {
 ...
 * @private unstable
 */
export declare enum AccessPointStatus {
    Enable = "enable",
    Disable = "disable",
    Creating = "creating",
    Deleting = "deleting"
 ...
 * @private unstable
 */
export declare enum AcceleratorPrefetchJobStatus {
    Null = "NULL",
    Idle = "IDLE",
    Running = "RUNNING",
    Stopping = "STOPPING",
 ...
 * @private unstable
 */
export declare enum AuditJobStateType {
    Submitted = "Submitted",
    Running = "Running",
    Success = "Success",
    Failed = "Failed",
 ...
 * @private unstable
 */
export declare enum AuditScanType {
    Manifest = "Manifest",
    Scan = "Scan"
}
/**
 ...
 * @private unstable
 */
export declare enum CallbackTriggerModeType {
    Freeze = "freeze",
    Sensitive = "sensitive",
    Failure = "failure"
}
 ...
 * @private unstable
 */
export declare enum FreezeModeType {
    Archive = "archive",
    Private = "private"
}
/**
 * @private unstable
 */
export declare enum TemplateTagType {
 ...
 * @private unstable
 */
export declare enum AudioContainerFormatType {
    Wav = "wav",
    Mp3 = "mp3",
    Aac = "aac",
    Flac = "flac",
 ...
 * @private unstable
 */
export declare enum ContainerFormatType {
    Mp4 = "mp4",
    Ts = "ts"
}
/**
 * @private unstable
 */
export declare enum SampleFormatType {
    Fltp = "fltp",
    S16p = "s16p",
    S32p = "s32p",
    S16 = "s16",
...
export declare enum DistanceMetricType {
