...
import { AzRedundancyType, StatusType, StorageClassType } from '../../TosExportEnum';
...
export declare function doesBucketExist(this: TOSBase, input: DoesBucketExistInput): Promise<boolean>;
...
export declare function getBucketInfo(this: TOSBase, input: GetBucketInfoInput): Promise<import("../base").TosResponse<GetBucketInfoOutput>>;
