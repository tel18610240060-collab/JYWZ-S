...
import { ACLType, StorageClassType, MetadataDirectiveType, AzRedundancyType, PermissionType, GranteeType, CannedType, HttpMethodType, LifecycleStatusType, StatusType, RedirectType, StorageClassInheritDirectiveType, TierType, VersioningStatusType, ReplicationStatusType, AccessPointStatusType, TransferAccelerationStatusType, MRAPMirrorBackRedirectPolicyType, WorkflowExecutionStateType, FileUncompressPrefixReplaced, FileCompressFlatten, AccessPointStatus, AcceleratorPrefetchJobStatus, AuditJobStateType, AuditScanType, AuditType, CallbackTriggerModeType, FreezeModeType, TemplateTagType, AudioContainerFormatType, SampleFormatType, DataType, DistanceMetricType } from './TosExportEnum';
...
declare class TosClient extends InnerClient {
    ...
    /** @private unstable */
    static FileUncompressPrefixReplaced: typeof FileUncompressPrefixReplaced;
    /** @private unstable */
    static FileCompressFlatten: typeof FileCompressFlatten;
    ...
    /** @private unstable */
    static AccessPointStatus: typeof AccessPointStatus;
    /** @private unstable */
    static AcceleratorPrefetchJobStatus: typeof AcceleratorPrefetchJobStatus;
    /** @private unstable */
    ...
    /** @private unstable */
    static WorkflowExecutionStateType: typeof WorkflowExecutionStateType;
    /** @private unstable */
    static ShareLinkClient: typeof ShareLinkClient;
    /** @private unstable */
    static AuditJobStateType: typeof AuditJobStateType;
    /** @private unstable */
    static AuditScanType: typeof AuditScanType;
    /** @private unstable */
    static AuditType: typeof AuditType;
    /** @private unstable */
    static CallbackTriggerModeType: typeof CallbackTriggerModeType;
    /** @private unstable */
    static FreezeModeType: typeof FreezeModeType;
    /** @private unstable */
    static TemplateTagType: typeof TemplateTagType;
    /** @private unstable */
    static AudioContainerFormatType: typeof AudioContainerFormatType;
    /** @private unstable */
    static SampleFormatType: typeof SampleFormatType;
}
export default TosClient;
export { TosClient as TOS, TosClient };
export { TosServerError, TosClientError, isCancel, CancelError, TosServerCode, CancelToken, ACLType, StorageClassType, MetadataDirectiveType, AzRedundancyType, PermissionType, GranteeType, CannedType, HttpMethodType, LifecycleStatusType, RedirectType, StatusType, StorageClassInheritDirectiveType, TierType, VersioningStatusType, createDefaultRateLimiter, DataTransferType, UploadEventType, DownloadEventType, ResumableCopyEventType, ReplicationStatusType, AccessPointStatusType, AccessPointStatus, AcceleratorPrefetchJobStatus, TransferAccelerationStatusType, ShareLinkClient, MRAPMirrorBackRedirectPolicyType, WorkflowExecutionStateType, FileUncompressPrefixReplaced, FileCompressFlatten, AuditJobStateType, AuditScanType, AuditType, CallbackTriggerModeType, FreezeModeType, TemplateTagType, AudioContainerFormatType, SampleFormatType, DataType, DistanceMetricType, };
