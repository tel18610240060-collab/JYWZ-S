  ...
  class TOSBase {
    ...
    async fetch(method, path, query, headers, body, opts) {
      ...
      try {
        ...
        if (axios$1.isAxiosError(err) && ((_err$response = err.response) != null && (_err$response$headers = _err$response.headers) != null && _err$response$headers['x-tos-request-id'] || (_err$response2 = err.response) != null && (_err$response2$data = _err$response2.data) != null && _err$response2$data.requestId)) {
